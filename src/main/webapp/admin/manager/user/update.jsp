...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/admin-update-user.css">
</head>
<body>
<header>
    <div class="navbar">
        <div class="navbar-container">
            <a href="<c:url value="/admin/nav.jsp"/>">
                ...
                <span class="nav-info">更新用户信息</span>
            </a>
        </div>
    </div>
</header>
            ...
            <div class="row">
                <div class="col">
                    <div class="card card-profile">
                        ...
                        <form autocomplete="off" method="post" action="<c:url value="/admin/api/updateUser"/>">
                            <input type="number" value="<%= request.getParameter("id") %>" name="adminId" hidden>
                            <input type="number" value="<%= user.getId() %>" name="userId" hidden>
                            <div class="form-item">
                                <label for="name">姓名</label>
                                <input type="text" id="name" name="name" maxlength="20" value="<%= user.getName() %>">
                            </div>
                            <div class="form-item">
                                <label for="account">账号</label>
                                <input type="text" id="account" name="account" maxlength="20" value="<%= user.getAccount() %>">
                            </div>
                            <div class="form-item">
                                <label for="password">密码</label>
                                <input type="text" id="password" name="password" maxlength="20" value="<%= user.getPassword() %>">
                            </div>
                            <div class="form-item">
                                <label for="sex">性别</label>
                                <input type="text" id="sex" name="sex" maxlength="20" value="<%= user.getSex() %>">
                            </div>
                            <div class="form-item">
                                <label for="college">学院</label>
                                <input type="text" id="college" name="college" maxlength="20" value="<%= user.getCollege() %>">
                            </div>
                            <div class="form-item">
