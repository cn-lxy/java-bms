...
<%
    if (admin.initAdminByID() == admin.INIT_FAILED) {
...
<header>
    <div class="navbar">
        <div class="navbar-container">
            <a href="${pageContext.request.contextPath}/admin/manager/user?id=${admin.getId()}">
                <span class="nav-logo"></span>
                <span class="nav-info">用户管理</span>
            </a>
        </div>
    </div>
</header>
            ...
            <div class="row">
                <div class="col">
                    <div class="card card-profile">
                        ...
                        <form autocomplete="off" method="post" action="<c:url value="/admin/api/addUser"/>">
                            <input type="number" name="adminId" value="${admin.getId()}" hidden>
                            <div class="form-item">
                            ...
                            <div class="form-item">
                                ...
                                <input type="text" id="college" name="college" maxlength="20">
                            </div>
                            <div class="form-item">
