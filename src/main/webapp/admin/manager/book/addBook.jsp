...
<head>
    ...
    <link rel="stylesheet" href="../../../static/css/admin-updateBook.css">
</head>
<body>
<header>
    <div class="navbar">
        <div class="navbar-container">
            <a href="${pageContext.request.contextPath}/admin/manager/book?id=${admin.getId()}">
            ...
            <div class="row">
                <div class="col">
                    <div class="card card-profile">
                        ...
                        <form autocomplete="off" method="post" action="<c:url value="/admin/api/addBook"/>">
                            <input type="number" name="id" value="<%= request.getParameter("id") %>" hidden>
                            <div class="form-item">
                            ...
                            <div class="form-item">
                                ...
                                <input type="month" id="pressDate" name="pressDate">
                            </div>
                            <div class="form-item">
